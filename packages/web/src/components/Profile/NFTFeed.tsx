    ...
    const { data, loading, error, fetchMore } = useQuery(PROFILE_NFT_FEED_QUERY, {
        variables: {
            request: {
                ...
                chainIds: IS_MAINNET ? [chain.mainnet.id, chain.polygon.id] : [chain.polygonMumbai.id, chain.kovan.id],
    ...
    return (
        <div>
            ...
            <InfiniteScroll
                ...
                hasMore={pageInfo?.next && pageInfo?.totalCount && nfts.length !== pageInfo?.totalCount}
